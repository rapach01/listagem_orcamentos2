            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pesquisa-tab" data-bs-toggle="tab"
                            data-bs-target="#pesquisa" type="button" role="tab" aria-controls="pesquisa"
                            aria-selected="true">Pesquisa</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade" id="cadastro" role="tabpanel" aria-labelledby="cadastro-tab">
                        <form action="estrutura_controller" method="POST" id="cadastroForm">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="nome_estrutura" name="nome_estrutura" class="form-control"
                                    placeholder="Nome da Estrutura" required>
                            </div>
                            <button type="button" class="btn btn-md btn-secondary mt-3 add-material-btn text-right"
                            title="Adicionar Material" onclick="addMaterialRow()">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
                                ...
                                <button type="submit" class="btn btn-dark btn-lg ms-md-2 ml-3">
                                    <i class="fas fa-save" title="Cadastrar estrutura"></i>
                                </button>
                            </div>
                        </form>
                    </div>
...
<script>
    function addMaterialRow(materialId = '', quantidade = '') {
        ...
        <div class="col-md-1">
            <button type="button" class="btn btn-danger btn-sm" style="margin-top: 5px;" onclick="removeMaterialRow(this)" >
                <i class="fas fa-times" title="Remover"></i>
            </button>
        </div>
    `;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("reset").addEventListener("click", function() {
            document.getElementById("id_estrutura").value = "";
        });
        ...
        fetch('estrutura_controller?action=listar')
            ...
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    <div>
                        <button class="btn btn-sm btn-success me-2" title="Editar" onclick="editEstrutura(${estrutura.id_estrutura})">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-sm btn-danger" title="Excluir" onclick="deleteEstrutura(${estrutura.id_estrutura})">
        ...
        fetch(`estrutura_controller?id=${id}&action=editar`)
            ...
            .then(estrutura => {
                ...
                estrutura.materiais.forEach(material => {
                    addMaterialRow(material.id_material, material
                        .quantidade); // Adiciona a linha de material com dados preenchidos
                });
